...
| [workflow-orchestration-matrix.json](workflow-orchestration-matrix.json) | graph 编排能力矩阵，列出已完成能力、证明命令、conformance case 和规划缺口 | 对标 LangGraph 级编排能力、规划 graph/runtime 下一步缺口 |
