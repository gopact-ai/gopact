...
| A2A continuous env mesh sync | `a2a/env.go` | `go test -count=1 ./a2a -run TestMeshSyncEnvEvery` | standard A2A environment variables, interval resync, context cancellation, and positive interval validation |
