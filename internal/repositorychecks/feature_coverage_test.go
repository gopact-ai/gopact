...
func TestFeatureCoverageMatrixDocumentsCoreCapabilities(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			boundary:   "step export/import, interrupted step resume, branch routing, DAG fan-in, dynamic fan-out, loop step limits, runnable subgraphs, node-emitted nested events",
		},
		{
