...
- Target name: `<fill from docs/design/extension-conformance.json>`
...
List every required conformance suite from the target entry in `docs/design/extension-conformance.json`.
