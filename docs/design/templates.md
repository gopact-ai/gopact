...
- remote A2A authenticated cancel 已有 policy requested/decided、canceled 事件顺序 golden trajectory fixture，并复用 auth audit metadata 断言确认 sanitized auth context 同时进入 policy、remote cancel context、terminal event 和 tool result metadata；
