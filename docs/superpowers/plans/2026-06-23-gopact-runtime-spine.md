...
- `docs/design/index.md`: link this plan from the design entry.
...
- Modify: `docs/design/index.md` if implementation details changed during Tasks 1-7.
...
```bash
git add README.md docs/design/index.md example_test.go
